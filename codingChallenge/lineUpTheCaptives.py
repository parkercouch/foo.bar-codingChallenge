...
# lazy and few in number. Only one guard is stationed at each end of the rabbit 
...
# be lined up such that a viewer on one end sees x rabbits, and a viewer on the 
...
# 50 cm, 40 cm, and then 20 cm, a guard looking from the left side would see 
# 2 rabbits (30 and 50 cm) while a guard looking from the right side would see 
# 3 rabbits (20, 40 and 50 cm). 
# 
